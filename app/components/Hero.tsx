...
export default function Hero() {
  ...
  return (
    <section id="home" className="relative overflow-hidden h-[130vh] sm:h-[110vh] md:h-screen pt-8 sm:pt-20">
      ...
      <div className="absolute inset-0 overflow-hidden">
        ...
        {isMobile && (
          <motion.div
            ...
            className="absolute top-[60%] left-1/2 -translate-x-1/2 w-[300px] h-[300px] bg-gradient-to-br from-primary/10 via-accent/5 to-transparent rounded-full blur-xl"
          />
        )}
        {particles.map((p, i) => (
          <motion.div
        ...
        <motion.div
          ...
          className="absolute w-[150px] h-[150px] bg-gradient-to-br from-primary/20 via-accent/10 to-transparent rounded-full blur-2xl pointer-events-none"
        />
      </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-full relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center h-full">
          ...
          <div className="flex flex-col justify-center space-y-6">
            <span className="inline-block px-4 py-2 bg-primary/10 border border-primary/20 rounded-full text-primary max-w-2xs text-center">
          ...
          <div className="flex items-center justify-center lg:justify-end relative">
            <div className="relative">
              ...
              <motion.div
                ...
                className="relative overflow-hidden w-40 h-40 sm:w-60 sm:h-60 md:w-72 md:h-72 rounded-full border-2 border-primary shadow-lg bg-white"
              >
                <img
      ...
      >
        <ArrowDown size={32} className="text-primary opacity-0 md:opacity-50" />
      </motion.a>
    </section>
  );
}
